...
uses
  ...
  SqlExpr, DBClient, DBLocal,  DBLocalS, FMTBcd;

type
  TfrmNovoAssoc2 = class(TModeloInserir)
    ...
    procedure spEmailContaClick(Sender: TObject);
...
uses UDMConexao, UDMAssociado, captura, UFuncoes, UNovaObs, DBXUserControl,
  ...
  UDocumentoAdd, URegistrarPagto;

{$R *.dfm}

procedure TfrmNovoAssoc2.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.btfotoClick(Sender: TObject);
begin
  try
...
procedure TfrmNovoAssoc2.PegaDados(ass_id: integer);
begin
   //Foto
   ...
   //Guias Emitidades
   AtualizaGuiasEmitidas(ass_id);

   VerExistemeLote;

end;

procedure TfrmNovoAssoc2.spOBSAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.gridOBSDrawColumnCell(Sender: TObject;
...
procedure TfrmNovoAssoc2.btGravarClick(Sender: TObject);
var i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.editDataNascChange(Sender: TObject);
begin
  inherited;
   btgravar.Enabled :=true;
end;

procedure TfrmNovoAssoc2.editRepresentacaoCloseUp(Sender: TObject);
begin
  inherited;
//  btgravar.Enabled :=true;
end;

procedure TfrmNovoAssoc2.FormCloseQuery(Sender: TObject;
...
procedure TfrmNovoAssoc2.btGravarMouseMove(Sender: TObject;
...
procedure TfrmNovoAssoc2.btSairMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  btSair.setfocus;
...
procedure TfrmNovoAssoc2.Panel1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited;
  btSair.setfocus;
...
procedure TfrmNovoAssoc2.spOBSEditarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spOBSExcluirClick(Sender: TObject);
begin
  inherited;
 If DMAssociado.cdsObs.Active=true then
     If DMAssociado.cdsObs.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.spOBSPrintClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsObs.Active=true then
     If DMAssociado.cdsObs.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.spEnderAddClick(Sender: TObject);
var
   i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.gridEnderDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.gridContatoDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spEnderEditClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.SpEnderExcluiClick(Sender: TObject);
var
  msg:string;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spContatoAddClick(Sender: TObject);
var
   i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spContatoEditClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spContatoExcluirClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocContato.Active=true then
     If DMAssociado.cdsLocContato.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.spCorrespAddClick(Sender: TObject);
var
   i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spCorrespEditClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spCorrespExcluirClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocCorresp.Active=true then
     If DMAssociado.cdsLocCorresp.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.gridCorrespDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spRelAddClick(Sender: TObject);
var
   i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spRelEditClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spRelDelClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocRelacion.Active=true then
     If DMAssociado.cdsLocRelacion.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.spCapSocAddClick(Sender: TObject);
var
   i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spCapSocEditClick(Sender: TObject);
var
  i:integer;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spCapSocDelClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocCapSocial.Active=true then
     If DMAssociado.cdsLocCapSocial.RecordCount > 0 then
...
procedure TfrmNovoAssoc2.spSegmentoAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spSegmentoDelClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spSindAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spSindDelClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spDocsEntregueEditarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid8DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.gridCapSocialDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid6DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid7DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid10DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid11DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid11DblClick(Sender: TObject);
var
  b:TStream;
  f:TFileStream;
  arq:string;
...
procedure TfrmNovoAssoc2.sdAnexoAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spAnexosEditarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spAnexosDelClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocAnexos.RecordCount > 0 then
  begin
...
procedure TfrmNovoAssoc2.spMovimentoAddClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spMovimentoEditClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spMovimentoDelClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spMovimentoPrintClick(Sender: TObject);
begin
  inherited;
  If DMAssociado.cdsLocMoviment.RecordCount > 0 then
  begin
...
procedure TfrmNovoAssoc2.DBGrid9DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid1DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spPrevisaoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spBoletoClick(Sender: TObject);
var
  bol_id, i:integer;
...
begin
  ...
  begin
        ...
        begin
           ...
           begin
              Dmboleto.gbTitulo1.Visualiazar_SIGCB_e_PDF('Conf_'+anuidades+ '_'+Dmboleto.gbTitulo1.NossoNumero);
           ...
           begin
                ...
                try
                    if  Dmboleto.gbTitulo1.GerarPDF_SIGCB(caminho+'\'+pasta,'Confederativa_'+anuidades+'_'+Dmboleto.gbTitulo1.NossoNumero+  '.pdf') = 0 then
                    begin
           ...
           begin
                ...
                begin
                   ...
                   If frmBoleto.cbGuiaComplementar.Checked = true then
                     ...
                     begin
                         if frmBoleto.cdsAnuidadesVencimento.value < DataAtual then
                         begin
                             if vencdefinido =0 then
                             begin
                                 venc := DataAtual+1;
                                 Try Application.CreateForm(TfrmBoletoVencimento,frmBoletoVencimento);
                                 frmBoletoVencimento.edDataVencto.text := Datetostr(venc);
                                 if frmBoletoVencimento.showmodal = mrok then
                                 begin
                                      Venc := strtodate(frmBoletoVencimento.edDataVencto.text);
                                      vencdefinido :=1;
                    ...
                    DmBoleto.PROC_BOLETO_STATUS.ExecProc;
                     ...
                     try
                          ...
                          DmBoleto.PROC_BOLETO_I.ParamByName('VALOR_TOTAL').Value := Frmboleto.cdsAnuidadestotal.asfloat;
                     ...
                     begin
                        ...
                        DmBoleto.Guias1.Valores.Multa    := Frmboleto.cdsAnuidadesMulta.asfloat + Frmboleto.cdsAnuidadesJuros.asfloat;
                        DmBoleto.Guias1.Valores.Acrescimo    := Frmboleto.cdsAnuidadesCorrecao.asfloat;
                   ...
                   begin
                     ...
                     begin
                         DmBoleto.Guias1.Visualizar_CR_e_PDF('Sind_'+DmBoleto.Guias1.Exercicio+ '_'+DmBoleto.Guias1.Sacado.Contribuinte);
                         DMAssociado.dsDocsAnexos.dataset.close;
                         DMAssociado.dsDocsAnexos.dataset.open;
                     end;
                   ...
                   begin
                       ...
                       // ExibeAguarde('Preparando e-mail. Por favor aguarde...');
                        ...
                        try
                            if  Dmboleto.Guias1.GerarPDF_SIGCB(caminho+'\'+pasta, 'Sindical_' + inttostr(frmBoleto.cdsAnuidadesAno.value)+ '_'+DmBoleto.Guias1.Sacado.Contribuinte+'.pdf') = 0 then
                            begin
                                Aviso('Erro ao gerar arquivo PDF a ser enviado. ');
                                Exit;
                            end;
  ...
  AtualizaGuiasEmitidas(DMAssociado.cdsAssocASS_ID.Value);
  spBoleto.Click;

end;

procedure TfrmNovoAssoc2.spExtratoClick(Sender: TObject);
var
   validade :tdatetime;
   boletoEmail, visualizar, imprimir:integer;
   emailenvio, caminho, pasta, novoarquivo:string;
   tot, totsind, totconf, totparcel, totalpago:real;
   tottotal, totvalor, totmulta, totjuros, totcorrecao:Real;
...
begin
  ...
  begin
       ...
       begin
           ...
           begin
              ...
              if Dmfinancas.cdsExtratogeralTIPOCONTRIB.value='Sindical' then
               ...
               tottotal :=tottotal +Dmfinancas.cdsExtratogeralVALORTOTAL.asfloat ;
               totvalor:=totvalor +Dmfinancas.cdsExtratogeralVALOR.asfloat ;
               totmulta:=totmulta+ Dmfinancas.cdsExtratogeralMULTA.asfloat;
               totjuros:=totjuros +Dmfinancas.cdsExtratogeralJUROS.asfloat;
               totcorrecao:=totcorrecao+Dmfinancas.cdsExtratogeralCORRECAO.asfloat;
           end
           else
     ...
     QRExtrato.labtotalTotal.caption:= 'R$ ' + FormatCurr(',0.00',tottotal);
     QRExtrato.labtotalValor.caption:= 'R$ ' + FormatCurr(',0.00',totvalor);
     QRExtrato.labtotalJuros.caption:= 'R$ ' + FormatCurr(',0.00',totjuros);
     QRExtrato.labtotalMulta.caption:= 'R$ ' + FormatCurr(',0.00',totmulta);
     QRExtrato.labtotalCorrecao.caption:= 'R$ ' + FormatCurr(',0.00',totcorrecao);
 ...
 {    If totparcel = 0 then
     ...
     begin
        ...
        QRExtrato.labMulta.DataField:='';
         QRExtrato.labtotalTotal.caption:= ' ';
         QRExtrato.labtotalValor.caption:= ' ' ;
         QRExtrato.labtotalJuros.caption:= ' ' ;
         QRExtrato.labtotalMulta.caption:= ' ';
         QRExtrato.labtotalCorrecao.caption:= ' ' ;
...
procedure TfrmNovoAssoc2.spPrescricaoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.SpNovoParcClick(Sender: TObject);
var
  tipo, msg : String;
                                     ...
                                     begin
                                         ...
                                         begin
                                             ...
                                             try
                                                ...
                                                if DmFinancas.cdsDebitosAnuidadesVencimento.value < DataAtual then
                                                    Dmboleto.Guias1.Vencimento := Dataatual +1
                                                else
                                                ...
                                                DmBoleto.PROC_BOLETO_I.ParamByName('VALOR_TOTAL').Value := DmFinancas.cdsDebitosAnuidadesTOTAL.asfloat;
                                                DmBoleto.PROC_BOLETO_I.ParamByName('NOSSONUMERO').Value := DmBoleto.Guias1.Sacado.Contribuinte;
                                                DmBoleto.PROC_BOLETO_I.ParamByName('TPBOLETO_ID').Value := 1;
                                                DmBoleto.PROC_BOLETO_I.ParamByName('COMREGISTRO').Value := DMConexao.sdsConfigCOBRREGISTRADA.value;
                                                DmBoleto.PROC_BOLETO_I.ExecProc;
                                                ...
                                                DmBoleto.PROC_BOLETO_ITENS_I.ParamByName('VALOR_MULTA').value := DmFinancas.cdsDebitosAnuidadesMULTA.AsFloat;
                                                DmBoleto.PROC_BOLETO_ITENS_I.ParamByName('VALOR_JUROS').value := DmFinancas.cdsDebitosAnuidadesJUROS.AsFloat;
                                                DmBoleto.PROC_BOLETO_ITENS_I.ParamByName('VALOR_CORRECAO').value := DmFinancas.cdsDebitosAnuidadesCORRECAO.AsFloat;
                                                DmBoleto.PROC_BOLETO_ITENS_I.ExecProc;
                                             except
                                               Erro('Erro gerando o boleto/item NossoNumero=' + DmBoleto.gbTitulo1.NossoNumero);
                                               abort;
                                             ...
                                             DmBoleto.Guias1.Valores.Multa    := DmFinancas.cdsDebitosAnuidadesMULTA.asfloat + DmFinancas.cdsDebitosAnuidadesJUROS.asfloat;
                                             DmBoleto.Guias1.Valores.Acrescimo    := DmFinancas.cdsDebitosAnuidadesCORRECAO.asfloat;
...
procedure TfrmNovoAssoc2.DBGrid2ColEnter(Sender: TObject);
begin
  inherited;
  AtualizaParcelasParc;
...
procedure TfrmNovoAssoc2.AtualizaParcels;
begin
   //Parcelamentos
   DmFinancas.cdsParcelamento.close;
...
procedure TfrmNovoAssoc2.AtualizaParcelasParc;
begin
   If DmFinancas.cdsParcelamento.RecordCount > 0 then
   begin
...
procedure TfrmNovoAssoc2.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
 AtualizaParcelasParc;;
...
procedure TfrmNovoAssoc2.DBGrid2CellClick(Column: TColumn);
begin
  inherited;
  AtualizaParcelasParc;
end;

procedure TfrmNovoAssoc2.spExcluirParcClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.SpAtivarParcClick(Sender: TObject);
var     oper:integer;
        msg:string;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spManutencaoClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spManutencaoParcelamentoClick(Sender: TObject);
...
procedure TfrmNovoAssoc2.BitBtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.DBGrid5DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
...
procedure TfrmNovoAssoc2.Timer1Timer(Sender: TObject);
begin
  inherited;
  labparcelamento.Visible := not labparcelamento.Visible; 
end;

procedure TfrmNovoAssoc2.spPrintParcelClick(Sender: TObject);
...
procedure TfrmNovoAssoc2.spExtornoPrescClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.spIsencaoClick(Sender: TObject);
var
  obs:string;
begin
  inherited;
...
procedure TfrmNovoAssoc2.Regerar_Previsao;
begin
     Dmfinancas.PROC_ANUIDADE_DEL.close;
     Dmfinancas.PROC_ANUIDADE_DEL.ParamByName('ass_id').value:=DMAssociado.cdsAssocASS_ID.value ;
     Dmfinancas.PROC_ANUIDADE_DEL.ParamByName('dataatual').value:= DataAtual;
...
procedure TfrmNovoAssoc2.EditarVencimentoValor1Click(Sender: TObject);
begin
  inherited;
  If DmFinancas.cdsDebitosAnuidades.RecordCount > 0 then
  begin
...
procedure TfrmNovoAssoc2.DBGrid8DblClick(Sender: TObject);
begin
  inherited;
  if DMAssociado.cdsAssocTP_ASSOC_ID.value = 1 then
...
procedure TfrmNovoAssoc2.RefreshAll(ass_id: integer);
begin
  //Dados do Associado
  DMAssociado.cdsAssoc.close;
  DMAssociado.cdsAssoc.Params.ParamByName('ass_id').value := ass_id;
  DMAssociado.cdsAssoc.open;
  frmNovoAssoc2.Caption:='Dados de ' +DMAssociado.cdsAssocNOME.value;
  frmNovoAssoc2.labparcelamento.Visible:=false;
//  frmNovoAssoc2.pcPrincipal.ActivePage :=frmNovoAssoc2.tscontatos;
  frmNovoAssoc2.pcPrincipal.ActivePage :=frmNovoAssoc2.tsDadosPessoais;
  DMAssociado.cdsTp_Status.Open;
  DMAssociado.cdsEst_Civil.Open;
  DMAssociado.cdsTp_Pessoa.Open;
  DMAssociado.cdsEmp_Regiao.Open;
...
procedure TfrmNovoAssoc2.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.ImprimirGuia1Click(Sender: TObject);
var
  Venc:tdatetime;
  Valor_Boleto :real;
  conta:integer;
...
procedure TfrmNovoAssoc2.spReciboClick(Sender: TObject);
var
  recibo:string;
...
procedure TfrmNovoAssoc2.spReciboParcelamentoClick(Sender: TObject);
var
  recibo:string;
  bol_id, conta:integer;
  textoitem:string;
...
procedure TfrmNovoAssoc2.VerExistemeLote;
begin
...
procedure TfrmNovoAssoc2.tmrExisteLoteTimer(Sender: TObject);
begin
  inherited;
  LabelLoteExiste.Visible := not LabelLoteExiste.Visible;
end;

procedure TfrmNovoAssoc2.DBCtrlGrid1PaintPanel(DBCtrlGrid: TDBCtrlGrid;
  Index: Integer);
begin
  inherited;
...
procedure TfrmNovoAssoc2.TermodeParcelamento;
...
procedure TfrmNovoAssoc2.ConfissaodeDivida;
var
  qtd: integer;
...
procedure TfrmNovoAssoc2.ConfissaodeDividaParcelNovo;
var
  qtd: integer;
...
procedure TfrmNovoAssoc2.DBGrid13DblClick(Sender: TObject);
var
  arq:string;
begin
...
procedure TfrmNovoAssoc2.spDocumentoNOvoClick(Sender: TObject);
var
    arquivo:string;
begin
  inherited;
...
procedure TfrmNovoAssoc2.spDocumentoExcluirClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmNovoAssoc2.CALVALORTOTNOVO;
var X:INTEGER;
begin
  valortotParNOvo :=0;
...
procedure TfrmNovoAssoc2.spEmailClick(Sender: TObject);
var
   texto:string;
begin
  inherited;

  if not(dmassociado.cdsDocsAnexosTPNOTIF_ID.value in [2,4]) then
  begin
  ...
  begin
          ...
          try
                ...
                frmExtratoEnviarEmail.Memomsg.Lines.Add('Site: www.sircomrj.com.br');
                frmExtratoEnviarEmail.Memomsg.Lines.Add('E-mail: sindicato@sircomrj.com.br');
                frmExtratoEnviarEmail.Memomsg.Lines.Add('Endereço: Av. Graça Aranha 416 Sl. 425, Castelo, Rio de Janeiro, CEP 20.030-001');
                frmExtratoEnviarEmail.Memomsg.Lines.Add('Tel: (21) 2524-2859 (21) 2210-1838');
                ...
                begin
                     try
                          ...
                          begin
                               Aviso('Erro ao enviar e-mail.  '+chr(13)+ 'Verifique se o e-mail está correto e/ou se seu computador está conectado a internet. ' );
                                EscondeAguarde;
                          end;
                     except
                          EscondeAguarde;
  ...
  if dmassociado.cdsDocsAnexosTPNOTIF_ID.value = 2 then
  begin
          if Pos('Sind',dmassociado.cdsDocsAnexosCAMINHO.value) > 0 then
          begin
              texto := Copy(dmassociado.cdsDocsAnexosCAMINHO.value, Pos('Sind',dmassociado.cdsDocsAnexosCAMINHO.value),9);
          ...
          try
                ...
                frmExtratoEnviarEmail.edPARA.ReadOnly:=true;
                frmExtratoEnviarEmail.labmsg.caption :='';
                frmExtratoEnviarEmail.edAssunto.text := 'Confissão de Dívida';

                if DMAssociado.cdsAssocEMP_ID.value = 2 then
                begin
                    frmExtratoEnviarEmail.Memomsg.Lines.clear;
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('SINDICATO DOS REPRESENTANTES COMERCIAIS DO ESTADO DO RIO DE JANEIRO');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Aos cuidados de: '+ Dmassociado.cdsAssocNOME.value + ' (Cadastro Nº ' + copy(DMAssociado.cdsAssocREGISTRO.value,1,7)+'/'+copy(DMAssociado.cdsAssocREGISTRO.value,8,4)+').');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Prezado Senhor(a),');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Conforme combinado, segue em anexo a confissão de dívida relativo ao acordo firmado nesta data por V.Sa., a qual deverá ser impressa, assinada e devolvida através de SEDEX.');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Enfatizamos que o acordo só terá validade após recebermos o comprovante de pagamento da primeira parcela e a confissão de dívida devidamente assinada.');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('O endereço para envio da correspondência é o mesmo constante na assinatura abaixo:');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Atenciosamente,');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Sindicato dos Representantes Comerciais do Rio de Janeiro');
                ...
                begin
                    frmExtratoEnviarEmail.Memomsg.Lines.clear;
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('SINDICATO DOS REPRESENTANTES COMERCIAIS DO MUNICÍPIO DO RIO DE JANEIRO');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Aos cuidados de: '+ Dmassociado.cdsAssocNOME.value + ' (Cadastro Nº ' + copy(DMAssociado.cdsAssocREGISTRO.value,1,7)+'/'+copy(DMAssociado.cdsAssocREGISTRO.value,8,4)+').');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('');
                    frmExtratoEnviarEmail.Memomsg.Lines.Add('Prezado Senhor(a),');
...
procedure TfrmNovoAssoc2.DBGrid14DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  inherited;
 ...
 if (DMAssociado.sdsGuiasEmitidasSTATUS_ID.value = 2) then
  begin
    Tdbgrid(Sender).Canvas.Font.Color := clred;
    Tdbgrid(Sender).DefaultDrawDataCell(Rect, Column.Field, State);
  end;
...
procedure TfrmNovoAssoc2.AtualizaGuiasEmitidas(ass_id: Integer);
begin
  DMAssociado.sdsGuiasEmitidas.close;
  DMAssociado.sdsGuiasEmitidas.params.ParamByName('ass_id').Value := ass_id;
  DMAssociado.sdsGuiasEmitidas.Open;

end;

procedure TfrmNovoAssoc2.spAtivarDesativarClick(Sender: TObject);
var
   oper:string;
begin
  inherited;
  If DMAssociado.sdsGuiasEmitidas.Active = true then
  begin
     If DMAssociado.sdsGuiasEmitidas.RecordCount > 0 then
     begin
        If DMAssociado.sdsGuiasEmitidasSTATUS_ID.value = 1 then
           oper := 'Cancelar'
        else
           oper := 'Ativar';

         If Confirma('Deseja ' + oper+' a Guia/Recibo Nº ' +  DMAssociado.sdsGuiasEmitidasNOSSONUMERO.value+'?'  ) then
         begin
              Dmboleto.cdsBoletoStatus.close;
              Dmboleto.cdsBoletoStatus.Params.ParamByName('bol_id').value := DMAssociado.sdsGuiasEmitidasBOL_ID.value;
              if DMAssociado.sdsGuiasEmitidasSTATUS_ID.value = 1 then
              ...
              If Dmboleto.cdsBoletoStatusRESP.value = 0 then
                 Aviso('A Guia/Recibo não pôde ser alterada pois um ou mais'+#13+'de seus ítens tem um outro boleto ativo.')
              else
              begin
                 DMAssociado.sdsGuiasEmitidas.Refresh;
                 DMConexao.Log('Ativação/Cancelamento de Boleto/Guia pata o Filiado ' + DMAssociado.sdsGuiasEmitidasREGISTRO.value+'-'+DMAssociado.sdsGuiasEmitidasNOME.value+' - Boleto/Guia:'+DMAssociado.sdsGuiasEmitidasNOSSONUMERO.value, 'O', DMAssociado.sdsGuiasEmitidasIDASSOC.value);
              end;
         end;
     end;
  end
...
procedure TfrmNovoAssoc2.spPagarClick(Sender: TObject);
begin
  inherited;
  If dsGuiasEmitidas.DataSet.active = true then
  begin
    if dsGuiasEmitidas.DataSet.RecordCount > 0 then
    begin
       If dsGuiasEmitidas.DataSet.fieldbyname('STATUS').value = 'Cancelado' then
           Aviso('O Boleto/Guia selecionado está cancelado. ')
       else
       begin
          If (dsGuiasEmitidas.DataSet.fieldbyname('DATAPAGAMENTO').value =  null) or (dsGuiasEmitidas.DataSet.fieldbyname('DATAPAGAMENTO').value = Datanula) then
          begin
             Try application.createform(TfrmRegistrarPagto,frmRegistrarPagto);
             frmRegistrarPagto.labguia.caption := dsGuiasEmitidas.DataSet.fieldbyname('NOSSONUMERO').value;
             frmRegistrarPagto.labVencimento.caption := datetostr(dsGuiasEmitidas.DataSet.fieldbyname('DATAVENCIMENTO').value);
             frmRegistrarPagto.labTotal.caption := floattostr(dsGuiasEmitidas.DataSet.fieldbyname('VALOR').value);
             valorprinc := DMAssociado.sdsGuiasEmitidasVALOR.asfloat;
             if frmRegistrarPagto.showmodal=mrok then
             begin

               PROC_BOLETO_PAGAR_MANUAL.Close;
               PROC_BOLETO_PAGAR_MANUAL.ParamByName('pago').value := 1;
               PROC_BOLETO_PAGAR_MANUAL.ParamByName('bol_id').value := dsGuiasEmitidas.DataSet.fieldbyname('bol_id').value;
               ...
               DMConexao.Log('Situação de Boleto: Baixa Manual de Pagamento de Boleto/Guia pata o Filiado ' + DMAssociado.sdsGuiasEmitidasREGISTRO.value+'-'+DMAssociado.sdsGuiasEmitidasNOME.value+' - Boleto/Guia:'+DMAssociado.sdsGuiasEmitidasNOSSONUMERO.value, 'O', DMAssociado.sdsGuiasEmitidasIDASSOC.value);
               dsGuiasEmitidas.DataSet.refresh;
             end;
             finally
          ...
          begin
             ...
             begin
               ...
               PROC_BOLETO_PAGAR_MANUAL.ExecProc;
               dsGuiasEmitidas.DataSet.refresh;
               DMConexao.Log('Situação de Boleto: Cancelamento de Pagamento de Boleto/Guia pata o Filiado ' + DMAssociado.sdsGuiasEmitidasREGISTRO.value+'-'+DMAssociado.sdsGuiasEmitidasNOME.value+' - Boleto/Guia:'+DMAssociado.sdsGuiasEmitidasNOSSONUMERO.value, 'O', DMAssociado.sdsGuiasEmitidasIDASSOC.value);
             end;
...
procedure TfrmNovoAssoc2.spEmailContaClick(Sender: TObject);
var
   anuidades,emailenvio, caminho, pasta:string;
   total:Real;
begin
  inherited;
  ...
  begin
       ...
       Limitar :=0;
       frmBoleto.cbGuiaComplementar.Visible:=false;
       frmBoleto.labtexto.caption:= 'Selecione as contribuições desejadas:';
       DmFinancas.cdsDebitosAnuidades.first;
       frmBoleto.cdsAnuidades.CreateDataSet;
       While not DmFinancas.cdsDebitosAnuidades.eof do
       begin
           frmBoleto.cdsAnuidades.Append;
           frmBoleto.cdsAnuidades.Edit;
           frmBoleto.cdsAnuidadesAno.value := DmFinancas.cdsDebitosAnuidadesANO.value;
           frmBoleto.cdsAnuidadesAnuid_Id.value := DmFinancas.cdsDebitosAnuidadesANUID_ID.value;
           frmBoleto.cdsAnuidadesCorrecao.asfloat := DmFinancas.cdsDebitosAnuidadesCORRECAO.asfloat;
           frmBoleto.cdsAnuidadesDescricao.value := DmFinancas.cdsDebitosAnuidadesDESCRICAO.value;
           frmBoleto.cdsAnuidadesJuros.asfloat := DmFinancas.cdsDebitosAnuidadesJUROS.asfloat;
           frmBoleto.cdsAnuidadesMulta.asfloat := DmFinancas.cdsDebitosAnuidadesMULTA.asfloat;
           frmBoleto.cdsAnuidadesNum_Parcela.value := DmFinancas.cdsDebitosAnuidadesNUM_PARCELA.value;
           frmBoleto.cdsAnuidadesParc_Id.value := DmFinancas.cdsDebitosAnuidadesPARC_ID.value;
           frmBoleto.cdsAnuidadesTipoContrib.value := DmFinancas.cdsDebitosAnuidadesTIPOCONTRIB.value;
           frmBoleto.cdsAnuidadestotal.asfloat := DmFinancas.cdsDebitosAnuidadesTOTAL.asfloat;
           frmBoleto.cdsAnuidadesTpContrib_id.value := DmFinancas.cdsDebitosAnuidadesTPCONTRIB_ID.value;
           frmBoleto.cdsAnuidadesValor.asfloat := DmFinancas.cdsDebitosAnuidadesVALOR.asfloat;
           frmBoleto.cdsAnuidadesVencimento.value := DmFinancas.cdsDebitosAnuidadesVENCIMENTO.value;
           frmBoleto.cdsAnuidades.Post;
           DmFinancas.cdsDebitosAnuidades.Next;
       end;
       frmBoleto.cdsAnuidades.First;
       ...
       begin
           ...
           begin
                if frmBoleto.cdsAnuidadesSelecionado.value = true then
                begin
                   total := total + frmBoleto.cdsAnuidadestotal.asfloat;
                   if Pos(inttostr(frmBoleto.cdsAnuidadesAno.value),anuidades) = 0 then
                   begin
                        If anuidades ='' then
                             anuidades := inttostr(frmBoleto.cdsAnuidadesAno.value)
                        else
        ...
        frmExtratoEnviarEmail.edPARA.ReadOnly:=true;
        frmExtratoEnviarEmail.labmsg.caption :='';
        frmExtratoEnviarEmail.edAssunto.text := 'Dados Bancários para pagamento';
        frmExtratoEnviarEmail.Memomsg.Lines.clear;
        if DMAssociado.cdsAssocEMP_ID.value = 1 then
        begin
            frmExtratoEnviarEmail.Memomsg.Lines.Add ('SINDICATO DOS REPRESENTANTES COMERCIAIS DO MUNICÍPIO DO RIO DE JANEIRO');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('');
            frmExtratoEnviarEmail.Memomsg.Lines.Add(DMAssociado.cdsAssocNOME.value+' ('+DMAssociado.cdsAssocREGISTRO.value+')');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Prezado Sr(a).');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Seguem abaixo os dados da conta e valor para depósito, referente as contribuições referentes aos Exercícios de ' + anuidades+', no valor de R$ ' + FormatFloat(',0.00', total)+'.');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Banco................... : BANCO DO BRASIL');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Agência................. : 1251-3');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Conta Corrente:..... : 24.007-9');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Razão Social: Sindicato dos Representantes Comerciais do Município do Rio de Janeiro');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('CNPJ:................. : 34.046.375/0001-04');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('VALOR: R$ '+  FormatFloat(',0.00', total)+'.');
        end
        else
        begin
            frmExtratoEnviarEmail.Memomsg.Lines.Add ('SINDICATO DOS REPRESENTANTES COMERCIAIS DO ESTADO DO RIO DE JANEIRO');
            ...
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Prezado Sr(a).');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Seguem abaixo os dados da conta e valor para depósito, referente as contribuições referentes aos Exercícios de ' + anuidades+', no valor de R$ ' + FormatFloat(',0.00', total)+'.');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Banco............... : SANTANDER');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Agência............. : 4571');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Conta Corrente:..... : 13-000183-3');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Razão Social: Sindicato dos Representantes Comerciais do Estado do Rio de Janeiro');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('CNPJ:............... : 30.141.717/0001-14');
            frmExtratoEnviarEmail.Memomsg.Lines.Add('VALOR: R$ '+  FormatFloat(',0.00', total)+'.');
        end;
        frmExtratoEnviarEmail.Memomsg.Lines.Add('');
        frmExtratoEnviarEmail.Memomsg.Lines.Add('Após efetuar o depósito, por favor encaminhe cópia do comprovante para o e-mail sindicato@sircomrj.com.br.');
        frmExtratoEnviarEmail.Memomsg.Lines.Add('');
        frmExtratoEnviarEmail.Memomsg.Lines.Add('Atenciosamente,');
        frmExtratoEnviarEmail.Memomsg.Lines.Add('');
        frmExtratoEnviarEmail.Memomsg.Lines.Add('____________________________________________________________');
        if DMAssociado.cdsAssocEMP_ID.value = 1 then
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Sindicato dos Representantes Comerciais do Município do Rio de Janeiro')
        else
            frmExtratoEnviarEmail.Memomsg.Lines.Add('Sindicato dos Representantes Comerciais do Estado do Rio de Janeiro');
        ...
        begin
             ...
             try
             ExibeAguarde('Enviando e-mail. Por favor aguarde...');
             if EnviarEmailsemAnexo(frmExtratoEnviarEmail.edPARA.text,frmExtratoEnviarEmail.edAssunto.text,RICH_HTML(frmExtratoEnviarEmail.Memomsg)) = 1 then
             begin
                 EscondeAguarde;

                 DMAssociado.PROC_OBS_UI.close;
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('OBS_ID').value:=0;
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('OBS_DESCRICAO').value:='Envio de E-mail: Dados bancários '+ anuidades +' / Valor: ' + FormatFloat(',0.00', total) +'.';
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('ASS_ID').value:= DMAssociado.cdsAssocASS_ID.value;
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('DT_OBS').value:= DataAtual;
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('HORA').value:= copy(timetostr( time()),1,5);
                 DMAssociado.PROC_OBS_UI.Params.ParamByName('USER_ID').value:=Userid;
             ...
             begin
               Aviso('Erro ao enviar e-mail.  '+chr(13)+ 'Verifique se o e-mail está correto e se o computador está conectado a internet. ' );
                EscondeAguarde;
             end;
             except
                EscondeAguarde;

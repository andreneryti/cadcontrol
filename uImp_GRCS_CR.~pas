...
type
  TImp_GRCS_CR = class(TQuickRep)
    ...
    procedure qrlExercicio1Print(sender: TObject; var Value: String);
    procedure qrlExecicio2Print(sender: TObject; var Value: String);
    procedure qrlUsoBancoPrint(sender: TObject; var Value: String);
...
procedure TImp_GRCS_CR.qrlDesconto1Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlValor1Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlAbatimento1Print(sender: TObject;
  var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlMulta1Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlCorrecao1Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlTotal1Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlValor2Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlAbatimento2Print(sender: TObject;
  var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlDesconto2Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlMulta2Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlCorrecao2Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlTotal2Print(sender: TObject; var Value: String);
begin
   If Value = '0,00' Then Value := '';
end;

procedure TImp_GRCS_CR.qrlExercicio1Print(sender: TObject;
  var Value: String);
begin
   Value := Copy(qrlVencimento1.Caption,4,2)+'/'+value;
end;

procedure TImp_GRCS_CR.qrlExecicio2Print(sender: TObject;
  var Value: String);
begin
 Value := Copy(qrlVencimento1.Caption,4,2)+'/'+value;
end;

procedure TImp_GRCS_CR.qrlUsoBancoPrint(sender: TObject;
  var Value: String);
begin
Value := Copy(qrlVencimento1.Caption,4,2)+'/'+value;
end;

procedure TImp_GRCS_CR.QRLabel84Print(sender: TObject; var Value: String);
begin
   Value := Value + ' ' +  Copy(qrlVencimento1.Caption,4,2)+'/'+ qrlExercicio1.Caption;
end;

procedure TImp_GRCS_CR.QRLabel66Print(sender: TObject; var Value: String);
begin
    If copy(DMConexao.sdsConfigNOMEEMP.value,1,1)='F' then
        Value := StringReplace(Value,'sindicato@sircomrj.com.br','faacerj@gmail.com',[rfreplaceall]);
